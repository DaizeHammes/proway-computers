...
export const produtos: IProduto[] = [
    ...
    { id: 4, descricao: "Fone gamer", preco: 599.99, descricaoPreco: "À vista no PIX", imagem: "./assets/fone-de-ouvido-2.jpg", quantidadeEstoque: 10 },
    ...
    { id: 8, descricao: "Placas de vídeo (2un.)", preco: 18449.99, descricaoPreco: "À vista no PIX", imagem: "./assets/placa-video.jpg", quantidadeEstoque: 10 },
